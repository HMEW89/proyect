                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" autocomplete="off"  name="buscarSolicitante" id="buscarSolicitante">
                                        <span class="input-group-btn">
                                            <button class="btn btn-primary btn-flat" type="submit"><span class="fa fa-search"></span>
                                            </button>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" disabled="disabled" name="infoSolicitante" id="infoSolicitante" value="<?= isset($solicitante['razonSocial']) ? $solicitante['razonSocial'] : '' ?>">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label for="">Fecha:</label>
                                        <input type="text" id="fecha" value="<?php echo date('d-m-Y'); ?>" disabled="disabled" readonly name="fecha">
                                </div>
                            </div>

                        </div>
                        <h2>Detalle de la Prestación</h2><hr>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="hidden" id="idSolicitante" name="idSolicitante">
                                        <input type="text" class="form-control" autocomplete="off"  name="buscarServicio">
                                          <span class="input-group-btn">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" autocomplete="off" name="observacion" id="observacion">
...
<div class="row">
                        <div class="col-md-12"><br>
                            <form action="<?php echo base_url();?>movimientos/ordenes/store" method="POST" id="add-orden">
                                ...
                                <h2 >Servicios Agregados a la Prestación</h2><hr>
        ...
        <div class="modal-content">
            ...
            <form class="" action="<?php echo base_url();?>index.php/solicitante/agregar2bd"  autocomplete="off" method="post" onsubmit="return validarFormulario()">
               <span class="section"></span>
                ...
                <label class="col-form-label col-md-3 col-sm-3  label-align">Ci/Nit: <span class="required">*</span></label>
