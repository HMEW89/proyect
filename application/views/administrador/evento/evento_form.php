                                ...
                                <div class="x_content">
                                    <form class="" action="<?php echo base_url();?>index.php/evento/agregarbd"  autocomplete="off" method="post" onsubmit="return validarFormulario()">
                                        ...
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Nombre del Evento: <span class="required">*</span></label>
                                        ...
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align"> Fecha Inicio del Evento: <span class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
                                        ...
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Fecha Fin del Evento <span class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
