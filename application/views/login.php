...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
  <head>
    ...
    <script
      ...
      defer
    ></script>
    <script src="<?php echo base_url();?>adminlte/assets/js/init-alpine.js"></script>
  </head>
  <body>
        ...
        <div class="flex flex-col overflow-y-auto md:flex-row">
          <div class="h-32 md:h-auto md:w-1/2">
            <img
              ...
              src="<?php echo base_url();?>adminlte/assets/img/login-office.jpeg"
              alt="Office"
            />
            <img
              aria-hidden="true"
              class="hidden object-cover w-full h-full dark:block"
              src="<?php echo base_url();?>adminlte/assets/img/login-office-dark.jpeg"
              alt="Office"
            />
          </div>
          <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
            <div class="w-full">
              ...
              <a
                ...
                href="<?php echo base_url();?>adminlte/index.html"
              >
                Log in
              </a>
